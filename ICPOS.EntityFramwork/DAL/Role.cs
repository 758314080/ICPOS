...
namespace ICPOS.EntityFramwork.DAL
{
	...
	public partial class Role
	{
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("Role_ID", "Role"); 
		}
		...
		public ICPOS.EntityFramwork.Model.Role GetModel(int Role_ID)
		{
			...
			ICPOS.EntityFramwork.Model.Role model=new ICPOS.EntityFramwork.Model.Role();
		...
		/// 得到一个对象实体
		/// </summary>
		public ICPOS.EntityFramwork.Model.Role DataRowToModel(DataRow row)
		{
			ICPOS.EntityFramwork.Model.Role model=new ICPOS.EntityFramwork.Model.Role();
			if (row != null)
			{
				...
				{
					model.Role_Description=row["Role_Description"].ToString();
				}
				if(row["Role_Priv_Level"]!=null && row["Role_Priv_Level"].ToString()!="")
				{
					model.Role_Priv_Level=int.Parse(row["Role_Priv_Level"].ToString());
				}
			}
			return model;
		}
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select Role_ID,Role_Name,Role_Description,Role_Priv_Level ");
		...
		public DataSet GetList(int Top,string strWhere,string filedOrder)
		{
			...
			strSql.Append(" Role_ID,Role_Name,Role_Description,Role_Priv_Level ");
			strSql.Append(" FROM Role ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
